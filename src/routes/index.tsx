...
const TIMELINE = [
  { date: "2026.03.16", title: "百日誓师", desc: "距离中考还有100天" },
  { date: "2026.03.27", title: "第一次聚餐", desc: "小霖吃了不少，但还是没吃饱😂。" },
  { date: "2026.04.04", title: "第二次聚餐", desc: "吃着吃着就各自沉浸在自己的世界里了😂" },
  { date: "2026.04.30", title: "第三次聚餐", desc: "烤肉局的快乐，就是还没熟大家就已经开始期待了🔥" },
  { date: "2026.05.08", title: "第一次市模结束", desc: "大家都考出了自己理想的成绩" },
  { date: "2026.06.05", title: "第二次市模结束", desc: "最后一次市模拟🥺" },
  { date: "2026.06.24", title: "毕业典礼", desc: "马上分别，奔赴考场，互相道别👋" },
];
...
const WORDS = [
  {
    to: "致 小渲",
    body: "小渲，毕业快乐。你的英语一直都很厉害，也很稳定。以后不管去哪，希望你都能继续保持这种从容和优秀，前路一定会很亮。",
  },
  {
    to: "致 小霖",
  ...
  {
    to: "致 小郭",
    body: "小郭，你平时总是安静踏实，愿你未来的每一步，都走得稳稳当当，坚定而有方向。",
  },
  {
    to: "致 小娇",
